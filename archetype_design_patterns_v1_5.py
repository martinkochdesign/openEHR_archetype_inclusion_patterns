...
for origin_archetype in archetypeList:
	...
	if a_often or a_sometimes:
		info_text += '<h4 style="margin:0 0 10px 0; color:#8888a4; font-size:11px; text-transform:uppercase; letter-spacing:1px;">Includes</h4>'
		...
		if a_often:
			...
			for a_o in a_often:
				info_text += '<li style="padding:4px 0 4px 12px; border-left:2px solid #00d4aa; margin-bottom:4px; font-size:12px;">' + a_o[1] + '</li>'
			info_text += '</ul></div>'
		...
		if a_sometimes:
			...
			for a_s in a_sometimes:
				info_text += '<li style="padding:4px 0 4px 12px; border-left:2px solid #6c63ff; margin-bottom:4px; font-size:12px;">' + a_s[1] + '</li>'
			info_text += '</ul></div>'

	# ── Included by section ──
	if b_often or b_sometimes:
		info_text += '<hr style="border:none; height:1px; background:rgba(255,255,255,0.06); margin:14px 0;">'
		info_text += '<h4 style="margin:0 0 10px 0; color:#8888a4; font-size:11px; text-transform:uppercase; letter-spacing:1px;">Included by</h4>'
		...
		if b_often:
			...
			info_text += '<ul style="list-style:none; padding:0; margin:4px 0 0 0;">'
			for b_o in b_often:
				info_text += '<li style="padding:4px 0 4px 12px; border-left:2px solid #00d4aa; margin-bottom:4px; font-size:12px;">' + b_o[0] + '</li>'
			info_text += '</ul></div>'
		...
		if b_sometimes:
			...
			for b_s in b_sometimes:
				info_text += '<li style="padding:4px 0 4px 12px; border-left:2px solid #6c63ff; margin-bottom:4px; font-size:12px;">' + b_s[0] + '</li>'
			info_text += '</ul></div>'

	# ── Empty state ──
	if not a_often and not a_sometimes and not b_often and not b_sometimes:
